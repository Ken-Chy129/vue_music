...
(function (global, factory) {
            ...
            if (vnode.tag === 'select') {
                ...
                if (curOptions.some(function (o, i) {
                    ...
                    var needReset = el.multiple ?
                        ...
                        binding.value !== binding.oldValue && hasNoMatchingOption(binding.value,
                            curOptions);
                    if (needReset) {
                        trigger(el, 'change');
                    }
    ...
    function actuallySetSelected(el, binding, vm) {
        ...
        if (isMultiple && !Array.isArray(value)) {
            warn(
                ...
                "expects an Array value for its binding, but got " + (Object.prototype.toString.call(value)
                    .slice(8, -1)),
                vm
            );
            return
    ...
    function parseHTML(html, options) {
        ...
        function parseStartTag() {
            ...
            if (start) {
                ...
                var end, attr;
                while (!(end = html.match(startTagClose)) && (attr = html.match(dynamicArgAttribute) || html.match(
                        attribute))) {
                    attr.start = index;
    ...
    function bind$1(el, dir) {
        el.wrapData = function (code) {
            return ("_b(" + code + ",'" + (el.tag) + "'," + (dir.value) + "," + (dir.modifiers && dir.modifiers
                    .prop ? 'true' : 'false') + (dir.modifiers && dir.modifiers.sync ? ',true' : '') +
                ")")
        };
    }
        ...
        for (i = 0, l = dirs.length; i < l; i++) {
            ...
            if (needRuntime) {
                ...
                res += "{name:\"" + (dir.name) + "\",rawName:\"" + (dir.rawName) + "\"" + (dir.value ? (
                    ",value:(" + (dir.value) + "),expression:" + (JSON.stringify(dir.value))) : '') + (dir.arg ?
                    (",arg:" + (dir.isDynamicArg ? dir.arg : ("\"" + (dir.arg) + "\""))) : '') + (dir.modifiers ?
    ...
    function genInlineTemplate(el, state) {
        ...
        if (ast && ast.type === 1) {
            ...
            return ("inlineTemplate:{render:function(){" + (inlineRenderFns.render) + "},staticRenderFns:[" + (
